...
export class ResultPage {
  ...
  dataInfo(){
    let alert = this.alertCtrl.create({
      ...
      message: '1. Perfect for plants <ul><li>Humidity: 50~60%</li><li>Temperature: 25~30°C</li><li>Moisture: 40~60%</li><li>Light: 400~600lx</li></ul><br>2. Small problems for plants <ul><li>Humidity: <50 or >60%</li><li>Temperature: <25 or >30°C</li><li>Moisture: <40 or >60%</li><li>Light: <400 or >600lx</li></ul><br>3. Huge problems for plants <ul><li>Humidity: <40 or >70%</li><li>Temperature: <20 or >35°C</li><li>Moisture: <30 or >70%</li><li>Light: <250 or >700lx</li></ul><br>4. Worst for plants <ul><li>Humidity: <30 or >80%</li><li>Temperature: <15 or >40°C</li><li>Moisture: <20 or >85%</li><li>Light: <150 or >850lx</li></ul><br>Humidity:<ul><li>Less than (<) 50% = Dry</li><li>More than (>) 60% = Wet</li></ul><br>Temperature:<ul><li>Less than (<) 25°C = Cold</li><li>More than (>) 30°C = Hot</li></ul><br>Moisture:<ul><li>Less than (<) 40% = Wet soil</li><li>More than (>) 60% = Dry soil</li></ul><br>Light:<ul><li>Less than (<) 400lx = Bright</li><li>More than (>) 600lx = Dark</li></ul>',
      buttons: ['OK']
    });
